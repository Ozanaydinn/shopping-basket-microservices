...
@RestController
@RequestMapping(path = "/api/updateUser")
public class UpdateUserController {
    ...
    public ResponseEntity<BaseResponse> updateUser(@PathVariable(value = "id") String id,
        ...
        try {
            ...
            return new ResponseEntity<>(new BaseResponse("User updated!"), HttpStatus.OK);
        } catch( Exception e){
            var errorMsg = "Error while processing update user request for id: " + id;
